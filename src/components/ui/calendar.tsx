  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label:
          'text-sm font-medium z-1 relative flex whitespace-nowrap border-none items-center',
        dropdowns: 'flex items-center space-x-2',
        dropdown_root: 'relative',
        dropdown:
          'appearance-none z-10 opacity-0 absolute inset-0 w-full h-full m-0 p-0 border-none cursor-pointer',
