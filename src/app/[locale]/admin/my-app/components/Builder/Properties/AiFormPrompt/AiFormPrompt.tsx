...
import { generateAiForm } from '@/lib/TemplateBuilder/AiPromptTemplate/actions';
...
type Props = {
  aiInitMessage: IAiMessage;
};

function AiFormPrompt({ aiInitMessage }: Props) {
  ...
  const handleSendPrompt = async () => {
    ...
    try {
      ...
      const {
        ...
        template: aiTemplate,
        rawResponse
      } = await generateAiForm(updatedHistory);
      ...
      setGeneratedTemplate(aiTemplate.vdom);
